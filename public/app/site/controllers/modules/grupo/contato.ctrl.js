...
.controller('GrupoContatoCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, InfoSrv, ContentPagesSrv, BoxContentsSrv, ContatoSrv, MobileOperatorsSrv ) { //GrupoHomeSrv
    
    var self = this;
    // Modal
    $scope.confModal = {
        templates: 'tpls/admin/modules/grupo/modal/contato.mod.html',
        titles: 'Contato',
        size: 'lg'
    };
    // Text Conf
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        ContatoSrv.get({segment: SEGMENTS.GRUPO},function(response){
