...
.controller('AcqContatoCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, InfoSrv, ContentPagesSrv, BoxContentsSrv, ContatoSrv, MobileOperatorsSrv ) { //GrupoHomeSrv
    
    // VAR
    var self = this;
    // Modal
    $scope.confModal = {
        templates: 'tpls/admin/modules/acq/modal/contato.mod.html',
        titles: 'Contato',
        size: 'lg'
    };
    // Text Conf
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        ContatoSrv.get({segment: SEGMENTS.ACQ},function(response){
