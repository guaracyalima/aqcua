...
.controller('AcqGaleriasCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, GaleriasSrv, InfoSrv ) {
    
    // VAR 
    var self = this
    $scope.confModal = {
        templates: 'tpls/admin/modules/acq/modal/galerias.mod.html',
        templaDel: 'tpls/admin/modules/acq/modal/galerias.delete.mod.html',
        titles: 'Galerias',
        size: 'lg'
    };
    // Text Conf
    ...
    // GET PAGE
    $scope.page = null;
    GaleriasSrv.get({type: 'request', cmd: 'pagina', segment: SEGMENTS.ACQ},function(response){
        $scope.page = response;
    });
    // DATATABLES
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        GaleriasSrv.get({segment: SEGMENTS.ACQ},function(response){
