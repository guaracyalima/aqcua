...
.controller('AcqHomeCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, SEGMENTS, PagesSrv, DTABLE ) { //GrupoHomeSrv
    
    // VAR 
    $scope.confModal = {
        templates: 'tpls/admin/modules/acq/modal/home.mod.html',
        titles: 'Home',
        size: 'lg'
    };
