...
.controller('AcqPubCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, ContentPagesSrv, PubSrv ) { //GrupoHomeSrv
    
    // VAR 
    $scope.confModal = {
        templates: 'tpls/admin/modules/acq/modal/pub.mod.html',
        titles: 'Publicidade',
        size: 'lg'
    };
    // Text Conf
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        PubSrv.get({segment: SEGMENTS.ACQ},function(response){
