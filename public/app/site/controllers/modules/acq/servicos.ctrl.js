...
.controller('AcqServicosCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, ContentPagesSrv, BoxContentsSrv, ServicosSrv, InfoSrv ) { //GrupoHomeSrv
    
    // VAR 
    $scope.confModal = {
        templates: 'tpls/admin/modules/acq/modal/servicos.mod.html',
        titles: 'Serviços',
        size: 'lg'
    };
    // Text Conf
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        ServicosSrv.get({segment: SEGMENTS.ACQ},function(response){
    ...
    $scope.actionUpdate = function( data ) {
        return Modal.openModal({
                ...
                callback: function($scope) {
                    ...
                    BoxContentsSrv.getArray({type: 'ref', cmd: data.id}, function( data ){
