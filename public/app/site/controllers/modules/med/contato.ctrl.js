...
.controller('MedContatoCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, InfoSrv, ContentPagesSrv, BoxContentsSrv, ContatoSrv, MobileOperatorsSrv ) { //GrupoHomeSrv
    
        
    // Modal
    var self = this;
    $scope.confModal = {
        templates: 'tpls/admin/modules/med/modal/contato.mod.html',
        titles: 'Contato',
        size: 'lg'
    };
    // Text Conf
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        ContatoSrv.get({segment: SEGMENTS.MED},function(response){
