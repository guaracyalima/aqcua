...
.controller('AcqSobreCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, InfoSrv, ContentPagesSrv, SobreSrv ) { //GrupoHomeSrv
    
    // VAR 
    var self = this
    $scope.confModal = {
        templates: 'tpls/admin/modules/acq/modal/sobre.basico.mod.html',
        titles: 'Sobre',
        size: 'lg'
    };
    // Text Conf
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        SobreSrv.get({segment: SEGMENTS.ACQ},function(response){
