...
.controller('GrupoHomeCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, PagesSrv, DTABLE, SEGMENTS ) { //GrupoHomeSrv
    
    // VAR 
    $scope.confModal = {
        templates: 'tpls/admin/modules/grupo/modal/home.mod.html',
        titles: 'Home',
        size: 'lg'
    };
