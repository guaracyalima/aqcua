...
.controller('FitNoticiasCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, NoticiasSrv, InfoSrv ) {
    
    // VAR 
    var self = this
    $scope.confModal = {
        templates: 'tpls/admin/modules/fit/modal/noticias.mod.html',
        templaDel: 'tpls/admin/modules/fit/modal/noticias.delete.mod.html',
        titles: 'Noticias',
        size: 'lg'
    };
    // Text Conf
    ...
    // GET PAGE
    $scope.page = null;
    NoticiasSrv.get({type: 'request', cmd: 'pagina', segment: SEGMENTS.FIT},function(response){
        $scope.page = response;
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        NoticiasSrv.get({segment: SEGMENTS.FIT},function(response){
