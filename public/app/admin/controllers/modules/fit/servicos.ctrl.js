...
.controller('FitServicosCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, ContentPagesSrv, BoxContentsSrv, ServicosSrv, InfoSrv ) { //GrupoHomeSrv
    
    // VAR 
    $scope.confModal = {
        templates: 'tpls/admin/modules/fit/modal/servicos.mod.html',
        titles: 'Serviços',
        size: 'lg'
    };
    // Text Conf
    ...
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        ServicosSrv.get({segment: SEGMENTS.FIT},function(response){
