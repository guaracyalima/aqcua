...
.controller('ShopSliderCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, DTABLE, SEGMENTS, SliderSrv, InfoSrv ) {
    
    // VAR 
    var self = this
    $scope.confModal = {
        templates: 'tpls/admin/modules/shop/modal/slider.mod.html',
        templaDel: 'tpls/admin/modules/shop/modal/slider.delete.mod.html',
        titles: 'Slider',
        size: 'lg'
    };
    // Text Conf
    ...
    // GET PAGE
    $scope.page = null;
    SliderSrv.get({type: 'request', cmd: 'pagina', segment: SEGMENTS.SHOP},function(response){
        $scope.page = response;
    });
    // DATATABLES
    $scope.dtOptions = DTOptionsBuilder.fromFnPromise(function() {
        var defer = $q.defer();
        SliderSrv.get({segment: SEGMENTS.SHOP},function(response){
