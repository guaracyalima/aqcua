...
.controller('MedHomeCtrl', function( $scope ,$state, $rootScope, $timeout, $compile, $q, ngToast, Modal, DTOptionsBuilder, DTColumnBuilder, SEGMENTS, PagesSrv, DTABLE ) { //GrupoHomeSrv
    
    // VAR 
    var self = this;
    $scope.confModal = {
        templates: 'tpls/admin/modules/med/modal/home.mod.html',
        titles: 'Home',
        size: 'lg'
    };
