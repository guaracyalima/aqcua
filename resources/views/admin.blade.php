...
<head>
    ...
    <!-- Audite -->
    <link rel="stylesheet" type="text/css" href="css/dist/admin.css">
...
<!--    <script src="components/ui-iconpicker/dist/scripts/ui-iconpicker.min.js"></script>-->
    ...
    <script src="app/admin/config/run.js"></script>
    <script src="app/admin/config/config.jcrop.js"></script>
    <script src="app/admin/constants/config.js"></script>
    <script src="app/admin/constants/config.datatables.js"></script>
    <script src="app/admin/constants/config.lazyload.js"></script>
    <script src="app/admin/config/config.js"></script>
    <script src="app/admin/services/abs.srv.js"></script>
    <script src="app/admin/services/auth.srv.js"></script>
    <script src="app/admin/services/modal.srv.js"></script>
    <script src="app/admin/controllers/main.ctrl.js"></script>
    <script src="app/admin/directives/iconpiker.dts.js"></script>
    
    <!-- Application Start SCRIPTS -->
    <script src="app/admin/route/web.js"></script>
